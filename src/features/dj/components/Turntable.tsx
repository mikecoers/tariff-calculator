...
export default function Turntable({ artworkUrl, spinning, accent, side }: TurntableProps) {
  return (
    <div className="relative mx-auto w-[180px] h-[180px] sm:w-[210px] sm:h-[210px] lg:w-[220px] lg:h-[220px]">
      <div
